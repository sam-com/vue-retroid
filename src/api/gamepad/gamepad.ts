import { NotificationTypes } from './../notification/nofitications';
...
export class VueGamepad {
	...
	private padConnected(e: any) {
		setNotification(`Gamepad connected in port #${e.gamepad.index}.`, {
			type: NotificationTypes.success,
		});
		document.body.classList.add('gamepad-connected');
	}

	private padDisconnected(e: any) {
		setNotification(`Gamepad disconnected in port #${e.gamepad.index}.`, {
